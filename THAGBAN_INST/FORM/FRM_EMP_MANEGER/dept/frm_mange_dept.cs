...
{
    public partial class frm_mange_dept : DevExpress.XtraEditors.XtraUserControl
    {
        public int id=0;
        ...
        private void btn_edite_Click(object sender, EventArgs e)
        {
            ...
            FRM.dept_desc= dept_desc;
            FRM.dept_name = dept_name;
            FRM.dept_state = dept_state;
            FRM.ShowDialog();
            get_data();
        }
        ...
        void delete()
        {
            if (id != 0)
            {
                try
                {
                    ...
                    {
                        TBL_DEPT del_cle = con.TBL_DEPT.Find(id);
                        // del_doc.DOC_ID = holiday_type_id;

                        con.TBL_DEPT.Remove(del_cle);
                        con.SaveChanges();
                        tost not = new tost();
        ...
        void get_sele()
        {
            ...
            {
                dept_desc = gridView2.GetFocusedRowCellValue("DEPT_DESC").ToString();
                 dept_state = gridView2.GetFocusedRowCellValue("DEPT_STATE").ToString();
               
               dept_name  = gridView2.GetFocusedRowCellValue("DEPT_NAME").ToString();
                id = Convert.ToInt32(gridView2.GetFocusedRowCellValue("DEPT_ID").ToString());
