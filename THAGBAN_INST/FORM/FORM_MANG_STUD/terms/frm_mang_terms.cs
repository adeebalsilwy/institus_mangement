...
{
    public partial class frm_mang_terms : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public void get_data()
        {
            ...
            dbContext.TBL_TERMS.LoadAsync().ContinueWith(loadTask =>
            {
                // Bind data to control when loading complete
                gridControl1.DataSource = dbContext.TBL_TERMS.Local.ToBindingList();
            }, System.Threading.Tasks.TaskScheduler.FromCurrentSynchronizationContext());
        }
        private void btn_save_Click(object sender, EventArgs e)
        {
            frm_add_terms add =new frm_add_terms();
            add.term_id =0;
            add.ShowDialog();
            get_data();
        }
        ...
        {
            frm_add_terms frm = new frm_add_terms();
            //frm.holiday_type_name=holiday_type_name;
            frm.spaicla_id = spiacla_id;
        ...
        void delete()
        {
            if (term_id != 0)
            {
                try
                {
                    ...
                    {
                        TBL_TERMS del_cle = con.TBL_TERMS.Find(term_id);
                        // del_doc.DOC_ID = holiday_type_id;

                        con.TBL_TERMS.Remove(del_cle);
                        con.SaveChanges();
        ...
        void get_sele()
        {
...

            {
                ...
                term_id = Convert.ToInt32(gridView2.GetFocusedRowCellValue("TERM_ID").ToString());
