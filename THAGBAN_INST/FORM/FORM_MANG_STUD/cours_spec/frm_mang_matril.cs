...
{
    public partial class frm_mang_matril : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public void get_data()
        {
            ...
            dbContext.TBL_SPE_COURS.LoadAsync().ContinueWith(loadTask =>
            {
                // Bind data to control when loading complete
                gridControl1.DataSource = dbContext.TBL_SPE_COURS.Local.ToBindingList();
        ...
        void delete()
        {
            if (id != 0)
            {
                try
                {
                    ...
                    {
                        TBL_SPE_COURS del_cle = con.TBL_SPE_COURS.Find(id);
                        // del_doc.DOC_ID = holiday_type_id;

                        con.TBL_SPE_COURS.Remove(del_cle);
                        con.SaveChanges();
                        tost not = new tost();
        ...
        void get_sele()
        {
...

            {
                ...
                id = Convert.ToInt32(gridView2.GetFocusedRowCellValue("ID").ToString());
