...
{
    public partial class frm_mange_lect_cours : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        void get_data()
        {
            ...
            dbContext.TBL_LECT_COURS.LoadAsync().ContinueWith(loadTask =>
            {
                ...
                gridControl1.DataSource = dbContext.TBL_LECT_COURS.Local.ToBindingList();
        ...
        {
            FRM_ADD_LECT_COURS FRM = new FRM_ADD_LECT_COURS();
            FRM.cours_id = 0;
        ...
        void delete()
        {
            if (cours_id != 0)
            {
                try
                {
                    ...
                    {
                        TBL_LECT_COURS del_cle = con.TBL_LECT_COURS.Find(cours_id);
                        // del_doc.DOC_ID = holiday_type_id;

                        con.TBL_LECT_COURS.Remove(del_cle);
                        con.SaveChanges();
        ...
        void get_sele()
        {
            if (gridView2.RowCount > 0)
            {
                ...
                cours_id = Convert.ToInt32(gridView2.GetFocusedRowCellValue("LECT_COURS_ID").ToString());
